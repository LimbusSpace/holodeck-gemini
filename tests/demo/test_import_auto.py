...
def main():
    ...
    imported_obj_0 = import_glb_asset(glb_path_0, 'imported_object_1')
    if imported_obj_0:
        print(f'Successfully imported as imported_object_1')
    else:
    ...
    imported_obj_1 = import_glb_asset(glb_path_1, 'imported_object_2')
    if imported_obj_1:
        print(f'Successfully imported as imported_object_2')
    else:
